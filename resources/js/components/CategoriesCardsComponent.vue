  ...
  <div>
      ...
      <div class="row t4-bg-orange">
          ...
          >
            ...
            <!-- inizio card -->
      <div
        class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 mb-5 d-flex flex-column align-items-center t4-category-label"
        v-for="category in categories"
        :key="category.id"
      >
        <!-- SEZIONE CHE FARA' VEDERE TUTTI I RISTORANTI AVENTI QUELLA CATEGORIA SELEZIONATA  -->
        <router-link
          :to="{ name: 'category-restaurants-filter', params: { slug: category.slug } }"
        >
            ...
            <div class=" col-xxl-8 col-xl-8 col-lg-8 col-md-10 col-sm-12 col-12 t4-img-company">
                <img :src="'/images/category_img/' + category.image" alt="immagine categoria" />
            </div>
