          ...
          >
            <div v-if="!formComplete" class="form">
              <div class="action">
                ...
                <div>
                  <label for="surname" class="t4-orange-text ms-2"
                    >Cognome *</label
                  >
                  <br />
                  <input
